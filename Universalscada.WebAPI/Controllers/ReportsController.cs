// Universalscada.WebAPI/Controllers/ReportsController.cs
...
public class ReportsController : ControllerBase
{
    ...
    public IActionResult ExportActionLogsReport([FromBody] List<Universalscada.core.Models.ActionLogEntry> logs)
    {
