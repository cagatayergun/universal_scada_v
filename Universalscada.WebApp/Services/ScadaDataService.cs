// Dosya: Universalscada.WebApp/Services/ScadaDataService.cs (SON KARARLI SÜRÜM)
...
public class ProductionStepDetailDto : Universalscada.Models.ProductionStepDetail
{
...
{
    public Universalscada.Models.ProductionReportItem Header { get; set; } = new();
...
// Universalscada.Models.TopAlarmData'nın kullanıldığı varsayılmıştır.
...
namespace Universalscada.WebApp.Services
{
    ...
    public class ScadaDataService : IAsyncDisposable
    {
        ...
        public async Task<List<Universalscada.core.Models.ActionLogEntry>?> GetActionLogsAsync(ActionLogFilters filters)
        {
            ...
            if (!response.IsSuccessStatusCode)
            {
                ...
                return new List<Universalscada.core.Models.ActionLogEntry>();
            }

            return await response.Content.ReadFromJsonAsync<List<Universalscada.core.Models.ActionLogEntry>>();
        }
        ...
        public async Task<byte[]> ExportActionLogsReportAsync(List<Universalscada.core.Models.ActionLogEntry> logs)
        {
