namespace Universalscada.UIControls
{
    /// <summary>
    ...
    public interface IStepEditor
    {
        ...
        /// </summary>
        /// <returns>Doldurulmuş Universalscada.Models.ScadaRecipeStep nesnesi.</returns>
        Models.ScadaRecipeStep GetStep();

        /// <summary>
        /// Verilen ScadaRecipeStep nesnesindeki verilerle kullanıcı arayüzünü doldurur.
        /// </summary>
        /// <param name="step">Arayüzü doldurmak için kullanılacak Universalscada.Models.ScadaRecipeStep nesnesi.</param>
