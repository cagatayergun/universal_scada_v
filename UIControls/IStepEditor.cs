namespace Telemetry.UIControls
{
    ...
    public interface IStepEditor
    {
        ...
        /// </summary>
        /// <returns>Doldurulmuş Telemetry.Models.ScadaRecipeStep nesnesi.</returns>
        Models.ScadaRecipeStep GetStep();

        /// <summary>
        /// Verilen ScadaRecipeStep nesnesindeki verilerle kullanıcı arayüzünü doldurur.
        /// </summary>
        /// <param name="step">Arayüzü doldurmak için kullanılacak Telemetry.Models.ScadaRecipeStep nesnesi.</param>
